...
test('the pilot publishes all flights and methods labs', () => {
	...
	assert.equal((pilot.match(/aria-controls="lab-[a-c]-content"/g) ?? []).length, 3);
	assert.equal((pilot.match(/class="flight-coming-soon"/g) ?? []).length, 0);

...
| --- | --- | --- |
| Takaoka casting industry began in 1611 | A long local metalworking history. | A secure first-tetsubin date, or a foundation date for a current brand. |
| Official Takaoka copperware account | A specialist production network and named metalworking techniques. | That every listed specialist worked on every kettle. |
| Current Takaoka Tetsubin catalogue | Present brand and product-title context. | Historical Ryūbundō provenance or a mark sequence. |
...
| --- | --- | --- |
| Model, mould, casting | Takaoka’s craft account names model-making and casting. | Do not infer a named specialist from a finished body. |
| Finishing and polishing | Both are listed as separate craft work. | A smooth or rough field is not a signature. |
| Engraving, inlay, colouring | All are documented regional techniques. | Name the technique only when the object source does; identify the performer only when stated. |
| Assembly and sale | A brand or seller may coordinate a finished kettle. | Sales identity is not body provenance. |

<figure class="figure-center figure-scroll" tabindex="0" role="region" aria-label="Takaoka attribution path"><img src="/tea/posts/tetsubin-history-6-takaoka/takaoka-attribution.svg" alt="takaoka attribution evidence card; full record in adjacent table." loading="lazy" decoding="async" /><figcaption>A work network produces several kinds of evidence, none of which can replace the other. Original diagram.</figcaption></figure>

| Start with | Then check | Never substitute |
| --- | --- | --- |
| A complete body and its original fittings | Object-level production record, exact mark, date and provenance. | Brand story, surface resemblance, or a detached lid. |
...
<figure class="figure-center figure-scroll" tabindex="0" role="region" aria-label="Koryo Kinjudo process"><img src="/tea/posts/tetsubin-history-6-takaoka/koryo-process.svg" alt="koryo process evidence card; full record in adjacent table." loading="lazy" decoding="async" /><figcaption>Regional technique is context, not a production affidavit for one brand. Original diagram.</figcaption></figure>

<figure class="figure-center figure-scroll" tabindex="0" role="region" aria-label="Koryo Kinjudo visual language"><img src="/tea/posts/tetsubin-history-6-takaoka/koryo-language.svg" alt="koryo language evidence card; full record in adjacent table." loading="lazy" decoding="async" /><figcaption>No product image has been traced or promoted into a maker diagnostic. Original diagram.</figcaption></figure>

<figure class="figure-center figure-scroll" tabindex="0" role="region" aria-label="Koryo Kinjudo object ceiling"><img src="/tea/posts/tetsubin-history-6-takaoka/koryo-object.svg" alt="koryo object evidence card; full record in adjacent table." loading="lazy" decoding="async" /><figcaption>A zero-pair evidence card is more useful than an invented representative object. Original diagram.</figcaption></figure>

<figure class="figure-center figure-scroll" tabindex="0" role="region" aria-label="Koryo Kinjudo distinction"><img src="/tea/posts/tetsubin-history-6-takaoka/koryo-distinction.svg" alt="koryo distinction evidence card; full record in adjacent table." loading="lazy" decoding="async" /><figcaption>The distinction is evidential, not a quality ranking. Original diagram.</figcaption></figure>
...
<figure class="figure-center figure-scroll" tabindex="0" role="region" aria-label="Ginshodo process"><img src="/tea/posts/tetsubin-history-6-takaoka/ginshodo-process.svg" alt="ginshodo process evidence card; full record in adjacent table." loading="lazy" decoding="async" /><figcaption>Technique title, performer, and provenance are three separate claims. Original diagram.</figcaption></figure>

<figure class="figure-center figure-scroll" tabindex="0" role="region" aria-label="Ginshodo visual language"><img src="/tea/posts/tetsubin-history-6-takaoka/ginshodo-language.svg" alt="ginshodo language evidence card; full record in adjacent table." loading="lazy" decoding="async" /><figcaption>Product titles are useful context, not a historical object catalogue. Original diagram.</figcaption></figure>

<figure class="figure-center figure-scroll" tabindex="0" role="region" aria-label="Ginshodo representative objects"><img src="/tea/posts/tetsubin-history-6-takaoka/ginshodo-object.svg" alt="ginshodo object evidence card; full record in adjacent table." loading="lazy" decoding="async" /><figcaption>Current *utsushi* is documented as current, which is the useful part of the evidence. Original diagram.</figcaption></figure>

<figure class="figure-center figure-scroll" tabindex="0" role="region" aria-label="Ginshodo distinction"><img src="/tea/posts/tetsubin-history-6-takaoka/ginshodo-distinction.svg" alt="ginshodo distinction evidence card; full record in adjacent table." loading="lazy" decoding="async" /><figcaption>An explicit homage label should prevent, not enable, a provenance claim. Original diagram.</figcaption></figure>
...
<figure class="figure-center figure-scroll" tabindex="0" role="region" aria-label="Shobee process"><img src="/tea/posts/tetsubin-history-6-takaoka/shobee-process.svg" alt="shobee process evidence card; full record in adjacent table." loading="lazy" decoding="async" /><figcaption>A distributed network is a question to investigate, not an answer to invent. Original diagram.</figcaption></figure>

<figure class="figure-center figure-scroll" tabindex="0" role="region" aria-label="Shobee visual language"><img src="/tea/posts/tetsubin-history-6-takaoka/shobee-language.svg" alt="shobee language evidence card; full record in adjacent table." loading="lazy" decoding="async" /><figcaption>Construction observations should be recorded before a name is proposed. Original diagram.</figcaption></figure>

<figure class="figure-center figure-scroll" tabindex="0" role="region" aria-label="Shobee object ceiling"><img src="/tea/posts/tetsubin-history-6-takaoka/shobee-object.svg" alt="shobee object evidence card; full record in adjacent table." loading="lazy" decoding="async" /><figcaption>There is no substitute for a complete-object record. Original diagram.</figcaption></figure>

<figure class="figure-center figure-scroll" tabindex="0" role="region" aria-label="Shobee distinction"><img src="/tea/posts/tetsubin-history-6-takaoka/shobee-distinction.svg" alt="shobee distinction evidence card; full record in adjacent table." loading="lazy" decoding="async" /><figcaption>Brand, maker, and provenance can align; they cannot be presumed to align. Original diagram.</figcaption></figure>
...
This distinction also protects contemporary makers. Inlay, engraving, colour and sophisticated casting are not made less skilled because a design enters into conversation with Kyoto. They become more intelligible when the seller credits the relationship accurately and when the reader does not ask a current product title to certify antique provenance.

<figure class="figure-center figure-scroll" tabindex="0" role="region" aria-label="Utsushi and provenance"><img src="/tea/posts/tetsubin-history-6-takaoka/utsushi-provenance.svg" alt="utsushi provenance evidence card; full record in adjacent table." loading="lazy" decoding="async" /><figcaption>These four claims can coexist, but evidence for one does not automatically establish another. Original diagram.</figcaption></figure>

| Term | It can establish | It cannot establish alone |
| --- | --- | --- |
| *Utsushi* / homage | A stated current reference to an older form. | Original workshop authorship. |
| Technical continuity | A documented practice or specialist technique. | An uninterrupted family or workshop line. |
| Brand attribution | Current seller/coordinator identity. | Who cast, decorated or signed the historic body. |
| Provenance | A documented object history. | A conclusion from style alone. |
...
- **Hero:** Met, [*Kettle (Kama) and Brazier (Furo)*, 25.215.32](https://www.metmuseum.org/art/collection/search/39566), used as a historical comparison.

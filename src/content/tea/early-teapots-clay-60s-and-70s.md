...
Source: https://www.facebook.com/groups/teapot2/posts/1444896825804983/
...
shiny, metallic-looking particles sometimes mistaken for yellow clay spots (which are normal and unrelated).

Workshops outside the factory, however, often used less refined clay. As a result, mica flakes are commonly seen on 
...
Factory teapots were fired inside saggars, so fly ash could not reach them.

“Fly ash” appearing inside the lid or inside the pot is physically impossible.

Dragon kilns were no longer used after the factory was established; downdraft kilns took their place.

So what are these black spots? They are simply impurities—mostly iron minerals—in the clay body. Under high temperatures, 
these minerals melt and migrate to the teapot’s surface, forming dark carbon-like dots.

In the 1960s and 70s, Factory 1 devoted great effort to impurity removal. Workers even used magnets to extract iron 
particles during processing—a labor-intensive and demanding step. For this reason, teapots from that period almost never 
show black carbon spots.

During the Green Label period and into the 1980s, production volumes grew dramatically. With higher output, clay purity 
...
✔️ Should NOT have mica flakes

✔️ Should NOT have black carbon spots

❌ Claims that mica flakes or “fly ash glaze” prove authenticity are incorrect

<b>For 1980s Factory 1 teapots:</b>

✔️ A small amount of mica flakes or carbon spots can be normal

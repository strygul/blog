...
<figure class="figure-center">
  <img src="/tea/posts/tetsubin-history-3-mizusawa-oshu/oigen-archival-machine-parts.png" alt="Worker tending a mechanized sand-moulding line at Oigen in Mizusawa" loading="lazy" decoding="async" />
  <figcaption>An undated archive photograph of Oigen’s mechanized mould-making line. Its catalogue record identifies machine parts as the main current product of Mizusawa casting; the image documents the industrial side of the same local foundry economy as kettle production. Photo: 山口直, 日本写真保存センター (Photo Archive Japan), <a href="https://photo-archive.jp/database/detail.php?id=00076-00136-0007">exact archive record</a>, <a href="https://rightsstatements.org/page/InC-EDU/1.0/?language=en">In Copyright–Educational Use Permitted</a>; unchanged institutional 800 × 800 rendition reused for this educational history, with no crop or recompression. The record supplies no date.</figcaption>
</figure>
...
<figure class="figure-center">
  <img src="/tea/posts/tetsubin-history-3-mizusawa-oshu/oigen-archival-streetlights.png" alt="Rows of cast-iron streetlight posts awaiting shipment at Oigen in Mizusawa" loading="lazy" decoding="async" />
  <figcaption>Cast-iron streetlight posts awaiting shipment at Oigen, in an undated archive photograph. The record connects this architectural ironwork to urban redevelopment, preserving evidence of Mizusawa casting beyond cookware. Photo: 山口直, 日本写真保存センター (Photo Archive Japan), <a href="https://photo-archive.jp/database/detail.php?id=00076-00136-0006">exact archive record</a>, <a href="https://rightsstatements.org/page/InC-EDU/1.0/?language=en">In Copyright–Educational Use Permitted</a>; unchanged institutional 800 × 800 rendition reused for this educational history, with no crop or recompression. The record supplies no date.</figcaption>
</figure>
...
- **Archival industrial context:** Photo Archive Japan records [Oigen’s mechanized mould-making line](https://photo-archive.jp/database/detail.php?id=00076-00136-0007) and [cast-iron streetlights awaiting shipment](https://photo-archive.jp/database/detail.php?id=00076-00136-0006). Both undated records are credited to 山口直 and carry the [In Copyright–Educational Use Permitted](https://rightsstatements.org/page/InC-EDU/1.0/?language=en) statement; unchanged institutional renditions are used here for educational history.
...
- **Images:** the exact file, creator, rights statement or license, and modification status appear in each caption. The CC BY-SA 3.0 hero is an uncropped local 1600 × 1200 derivative; both public-domain regional utility photographs are unchanged originals; both Photo Archive Japan files are unchanged educational-use renditions. All fourteen SVGs are original source-grounded diagrams; no restricted maker photograph or mark form was copied or traced.

---
title: "“Early Teapots”: The “Qing Yin” Series and Common Myths"
pubDate: "2026-04-26"
category:
  - "Tea"
...
Over the 1980s through the 2000s, output in many *Qing Yin* styles was enormous. Fakes are everywhere—roughly, **nine in ten** “Qing Yin” on the market are not 1970s pieces in the way sellers claim. Dealers layer keywords—“first batch,” “inverted bevel edge,” “fine long seal,” “red six purple four,” and so on—which creates noise for buyers who try to use single labels instead of period rules.
...
Two more pots have **Yin Feng** 銀鳯 in the **inner lid**: again, one carved *Qing yin Zhongguo wulong cha* with the 22-character base, one uncarved with the **1970s “China Yixing”** base.

The point: the same potters (same molds, same clays) made **branded** *Qing Yin* and **plain** catalog pots. **Shape, clay, work, and inner lid** treatment should not magically differ between “Qing Yin” and non-*Qing Yin* from the same year—only the carving and base text change. The first step in authenticating 1970s *Qing Yin* is to confirm **1970s F1** characteristics, then read the inscriptions.
...
**Shape and work.**  
Lid lip thickness, lid diameter and curvature, interior lid finish, air hole, rim, and other details follow **mold and workshop routine**; sizes vary, but the **style** of handling should match the 70s, not 80s+ shortcuts.
...
Logically, the **first** production runs of a new seal would not be defined by **accidental** damage. In reality, the marks come from **long seal wear** or **clay packing** in the incised lines, so impressions differ. Compare two **Mei Yun** 22-character bases: chipped-looking edges can sit on **different** character layouts—i.e. wear and impression quality, not a batch code. These were **free gift** pots, not a secret-marks program.

**Interview note (Zheng Mei Yun 鄭梅云, former F1 artisan).** F1 then issued **one name seal and one long base seal per worker**; bases were **buffalo horn or stone**, so from maker to maker, stroke depth and crispness differ. The stone seal could have a real chip on the **stone**—and that, not a “pioneer” fantasy, is what you sometimes see. For 1970s *Qing Yin*, treat the series as **one 70s run**; you cannot meaningfully split “pioneer” vs. “non-pioneer” by clay or work within the same period. Pots that are clearly **1980s** in make are a **different** generation from 70s *Qing Yin*.
...
**Format rules to watch:** each recognized worker effectively had **one** name layout—**Qiao Ying** square; **Mei Yun**, **Hui Fang**, **Zhi Qin** as two-character **vertical** pairs; **Yin Feng** as two characters **left–right**; and so on. Stray layouts are a reason to be cautious.

Pots with **no inner name** but 1970s work and clay are still **70s** standard product; the idea that “seal-less = earliest” is **not** supported. Compare clay, work, and carving; treat inner stamp presence as a detail, not a ranking.
...
The body inscription still uses a **pre-merger, 1960s-style** Fujian company name, while 1970s *Qing yin Zhongguo wulong cha* pieces use the **post-merger 土產畜產** / Xiamen 22-character story. The author reads this 1960s *Fujian ming cha* as an early **sibling in spirit** to the 1970s *Qing Yin* push: 1960s company names, 1960s clay and finish, **six-cup** lid, six-character Hui Mengcheng base. **Era-appropriate traits** stay fixed: 60s pots should look 60s; 70s *Qing Yin* should look 70s. Collectors who judge each pot in isolation, or from one “magic” detail, stay confused; a **system** of clay, work, and seals is how early F1 output becomes learnable.

---

### Takeaway

**Qing Yin** is a **family of early F1** export- and gift-oriented pots, not a separate universe of making. Beyond the **special inscriptions** and a few well-known long bases, a 1970s *Qing Yin* must **agree** with 1970s F1. Compare long enough against solid **70s** references, and the series becomes much less mysterious than the resale myths suggest.
